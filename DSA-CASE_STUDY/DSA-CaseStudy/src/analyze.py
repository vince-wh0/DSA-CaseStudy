...
from statistics import mean # Removed median, mode, StatisticsError
import math
...
def section_summary(rows: List[Record]) -> Dict[str, Dict[str, float]]:
    """Calculates just the mean for each section (used in main summary)."""
...
# --- REMOVED compare_section_performance FUNCTION ---

def get_class_statistics(rows: List[Record]) -> Dict[str, Any]:
    """Generates the main summary statistics for the whole class."""
    stats = {}
